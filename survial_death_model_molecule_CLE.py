...
#%% create data fold
path = 'D:/Yu-Chuan/ForYuChuan/python program/survial_death_model/CLE/single/'
...
# npy saving
save_name = path + 'SDM_CLE_molecule'
...
def CLE_claculate(model, P, dt, delay_time):   
    P[:,0] = x0  
...
V = stochMatrx (X, eq_n, Rxn)
delay_time = 60*20

result = CLE_claculate(model, X, dt, delay_time)
